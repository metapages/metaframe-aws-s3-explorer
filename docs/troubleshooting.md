...
Usually there is some popup error that will say what the problem is. In the case there isn't, open the browser inspector `F-12` on the keyboard, and view the console. There will definitely be an error in there. If you aren't sure what's an error and was isn't, feel free to take a screenshot of console messages and [create a new issue](https://github.com/metapages/metaframe-aws-s3-explorer/issues) with the screenshots attached.
