                ...
                <div v-if="state.showError === 'FETCH_ALL_BUCKETS'">
                  ...
                  <div id="my-tab-content" class="tab-content">
                    <div class="tab-pane active" id="cors">
                      ...
                      <p>This functionality is currently under development, for additional information please create a <a href="https://github.com/metapages/metaframe-aws-s3-explorer/issues" target="_blank">GitHub Issue</a>.</p>
                    </div>
                  </div>
                </div>
